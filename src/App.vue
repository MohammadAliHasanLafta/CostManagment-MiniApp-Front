...
>
  ...
  >
    ...
    <form @submit.prevent="handleSubmit">
      <div class="mb-4">
        <label for="todo-title" class="block text-gray-600 font-semibold pb-2" dir="rtl">موضوع هزینه</label>
        <input
      ...
      <div class="mb-4">
        <label for="todo-title" class="block text-gray-600 font-semibold pb-2" dir="rtl">مبلغ هزینه</label>
        <input
